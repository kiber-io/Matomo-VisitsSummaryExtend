 ...
 *
 */
namespace Piwik\Plugins\VisitsSummaryExtend\Reports;
...
class Get extends \Piwik\Plugin\Report
{
    ...
    protected function init()
    {
        ...
        $this->name          = Piwik::translate('VisitsSummaryExtend_VisitsSummaryExtend');
        $this->documentation = Piwik::translate('VisitsSummaryExtend_VisitsSummaryExtendReportDocumentation');
        ...
        $this->subcategoryId = 'VisitsSummaryExtend_VisitsSummaryExtend';
...
//								'nb_visits_converted',
    ...
    public function configureWidgets(WidgetsList $widgetsList, ReportWidgetFactory $factory)
    {
        $widgetsList->addWidgetConfig(
            $factory->createWidget()
                ->setName('VisitsSummaryExtend_WidgetLastVisits')
        ...
        $widgetsList->addWidgetConfig(
            $factory->createWidget()
                ->setName('VisitsSummaryExtend_WidgetVisits')
    ...
    private function getSparklineTranslations()
    {
        ...
        foreach ($translations as $metric => $key) {
            $translations[$metric] = Piwik::translate('VisitsSummaryExtend_' . $key);
        }

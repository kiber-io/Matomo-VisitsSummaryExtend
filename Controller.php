...
class Controller extends \Piwik\Plugin\Controller
{
    ...
    public function getSparklines()
    {
        ...
        return FrontController::getInstance()->fetchDispatch('VisitsSummaryExtend', 'get');
    }
    ...
    public function getEvolutionGraph()
    {
        ...
        $documentation = $this->translator->translate('VisitsSummaryExtend_VisitsSummaryExtendDocumentation') . '<br />'
        ...
        $selectableColumns = array(
            // columns from VisitsSummaryExtend.get
            'nb_visits',
            'nb_uniq_visitors',
            'nb_users',
            'avg_time_on_site',
        ...
        // "VisitsSummaryExtend_WidgetLastVisits" and "VisitsSummaryExtend_WidgetOverviewGraph"
    ...
    public static function getVisitsSummaryExtend()
    {
        $result = Request::processRequest("VisitsSummaryExtend.get", array(
